...
export async function getSiteSettings() {
  try {
    ...
    return {
      ...
      tagline: res.tagline || "Premium trading education",
      logoUrl: res.logo_url || null,
      contactEmail: res.contact_email || null,
      primaryColor: res.primary_color || "#2B2B2B",
      accentColor: res.accent_color || "#2B2B2B",
      contactPhone: res.contact_phone || null,
      address: res.address || null,
      seoTitle: res.seo_title || null,
      seoDescription: res.seo_description || null,
      seoKeywords: res.seo_keywords || null,
      ogImageUrl: res.og_image_url || null,
      footerText: res.footer_text || null,
      termsUrl: res.terms_url || null,
      privacyUrl: res.privacy_url || null,
      refundUrl: res.refund_url || null,
      facebookUrl: res.facebook_url || null,
      twitterUrl: res.twitter_url || null,
      youtubeUrl: res.youtube_url || null,
      instagramUrl: res.instagram_url || null,
      linkedinUrl: res.linkedin_url || null,
      whatsappNumber: res.whatsapp_number || null,
      googleAnalyticsId: res.google_analytics_id || null,
      metaPixelId: res.meta_pixel_id || null,
